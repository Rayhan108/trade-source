        ...
        {tabs.map((tab) => (
          <button
            ...
            className={`px-6 py-2 rounded-md font-medium transition-colors ${
              activeTab === tab ? "bg-blue-600 text-white" : "border border-gray-300 text-gray-700 hover:bg-gray-50"
            }`}
          >
            {tab}
          </button>
          ...
          <table className="w-full">
            ...
            <thead>
              <tr className="bg-green-200">
                ...
                <th className="px-6 py-4 text-left text-sm font-medium text-gray-900">Transaction ID</th>
                  ...
                  <td className="px-6 py-4">
                    <div>
                      ...
                      <div className="text-sm text-gray-500">
                        {transaction.service}, <span className="text-gray-400">{transaction.location}</span>
                      </div>
                    </div>
                  </td>
                  <td className="px-6 py-4 text-sm font-medium text-gray-900">{transaction.amount}</td>
                  <td className="px-6 py-4">
                    <span className={`text-sm font-medium ${transaction.statusColor}`}>{transaction.status}</span>
                  </td>
                  <td className="px-6 py-4">
