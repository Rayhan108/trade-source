      ...
      <div className="">
        ...
        <div className=" rounded-lg p-6 sm:p-8">
          ...
          <div className="mb-8 border-b border-black pb-3">
            ...
            <p className="text-gray-600 text-base leading-relaxed">
              Ensure your credentials are verified for a trusted and professional presence on YourTradeSource.
            </p>
          </div>

          <form onSubmit={handleSubmit} className="space-y-6">
            {/* Document Type Dropdown */}
              <label className="block text-sm font-medium text-gray-900 mb-3">Document Type</label>
            ...
            <div>
              <label className="block text-sm font-medium text-gray-900 mt-5">Front of your license</label>
        ...
        <div className="flex items-center justify-center">
          <div className="w-full  ">
            ...
            <div>
              <label className="block text-sm font-medium text-gray-900 mb-3">Back of your license</label>
