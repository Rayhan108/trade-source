...
export default function ProjectDetails() {
  ...
  return (
    <div className="max-w-4xl mx-auto p-6 bg-white min-h-screen">
      {/* Header */}
      <h1 className="text-2xl font-semibold text-gray-900 mb-8 border-b pb-3">Project Details</h1>

      {/* Profile Section */}
      <div className="flex items-start justify-between mb-8 pb-6 border-b border-gray-200">
        <div className="flex items-start space-x-4">
          <Image src={userImg} alt="Ellie Smith" className="w-16 h-16 rounded-full object-cover" width={500} height={500} />
          <div>
            <h2 className="text-xl font-semibold text-gray-900 mb-2">Ellie Smith Has Booked You</h2>
            <p className="text-gray-600 max-w-md">
              Giovanni C. is currently offline and will reach out once available in the app. You will be notified as
        ...
        <div>
          <div className="flex items-center justify-between mb-4">
            ...
            <div className="flex items-center space-x-2">
              <button onClick={handleDownloadQuote} className="flex items-center space-x-2 text-blue-600 hover:text-blue-700 font-medium">
