  ...
  return (
    <div className="max-w-7xl mx-auto bg-gray-50 p-6 rounded-lg">
      ...
      <div className="mb-6">
        ...
        <div>
          <p className="font-medium text-gray-800 mb-2">To-Do List for Cleaner</p>
      ...
      >
        ...
        <span className="text-black">Add Note or Photos for the Contractor</span>
      </button>
        ...
        <div className="max-w-xl mx-auto mt-2 p-4 bg-white rounded-lg shadow">
          ...
          <div className="mb-4">
            ...
            <div className="flex items-center gap-2">
              ...
              />
              <span className="text-xs text-gray-400">Accepted formats: JPG, PNG</span>
            </div>
          </div>
      ...
      {/* Cancel Modal */}
      <Modal open={cancelModalVisible} footer={null} onCancel={() => setCancelModalVisible(false)}>
        <div className="p-4">
