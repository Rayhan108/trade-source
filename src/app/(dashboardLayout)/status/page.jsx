    ...
    <div className="container  mx-auto p-4 bg-white">
      ...
      {bookings[activeTab]?.length > 0 ? (
        bookings[activeTab]?.map((booking) => (
          console.log(booking),
          <div key={booking.id} className="bg-[#F7F8F8] rounded-md p-4 mb-6 shadow-sm">
            {/* Header */}
            <div className="flex items-center mb-4">
              ...
              />
              <div>
                <h3 className="text-xl font-semibold">You&apos;ve Booked {booking.name}</h3>
                <p className="text-xs w-96 text-gray-500">
                  Giovanni C. is currently offline and will reach out once available in the app.
                  You will be notified as soon as they respond.
                </p>
              </div>
              <span className="ml-auto text-sm text-green-500 font-medium">Inprogress</span>
            </div>
  {/* Divider */}
      <div className="border-b border-gray-200 mb-8"></div>
            {/* Service Info */}
            <div className="mb-4">
              <p className="text-xl font-dm font-medium mb-2">{booking.service}</p>
