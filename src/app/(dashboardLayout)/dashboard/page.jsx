     ...
     <div className='w-[70%]'>
      ...
      <div className="grid grid-cols-1  gap-4">
        ...
        <div>
          ...
          <span className='bg-[#D4AF37] text-black px-3 py-1 text-xs rounded-xl'>VIP Contractor</span>
        </div>
            <p className="text-sm text-blue-600 mt-1">Edit Public Profile</p>
        </div>
        ...
        <div className="flex justify-between items-start">
          ...
          <div className="mt-4">
            ...
            <p className="text-sm text-gray-600 mt-1">Last Posted: 12/04/25</p>
          </div>
        </div>
        ...
        {/*Message */}
          <div className="bg-gray-100 rounded-md p-4 flex flex-col justify-between">
        <div className="flex justify-between items-start">
            <p className="text-lg font-medium text-gray-800">Pro Message</p>
