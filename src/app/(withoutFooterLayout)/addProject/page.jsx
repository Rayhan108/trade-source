...
const AddProject = () => {
  ...
  const addServiceType = (serviceName) => {
    if (
      serviceName.trim() &&
      !serviceTypes.find((s) => s.name.toLowerCase() === serviceName.toLowerCase())
    ) {
      const newService = {
        id: Date.now(),
  ...
  const onSubmit = (data) => {
    ...
    return (
      ...
      >
       ...
       <h1 className="text-3xl font-bold max-w-7xl mx-auto my-5">Upload Project Content</h1>
      ...
      <form onSubmit={handleSubmit(onSubmit)} className="space-y-6">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          ...
          <div>
            <label className="block text-sm font-medium text-gray-700 mb-2">Project Prices</label>
            <input
              type="text"
        ...
        <div>
          <label className="block text-sm font-medium text-gray-700 mb-3">Upload Project Photo</label>
          ...
          >
            <div className="flex flex-col items-center">
              ...
              <p className="text-gray-600 text-base">Drop photos here or click to upload</p>
            </div>
          </div>
