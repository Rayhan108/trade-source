...
const proContractor = true;
  ...
  const messages = [
    { id: 1, sender: "ellie", time: "10:16", content: "Vel et commodo...", type: "text" },
    { id: 2, sender: "ellie", time: "10:16", content: "/placeholder.svg?height=120&width=200", type: "image" },
    { id: 3, sender: "me", time: "10:45", content: "Est, eget est quis ornare...", type: "text" },
    { id: 4, sender: "ellie", time: "11:04", content: "Vestibulum viverra lacus...", type: "text" },
    { id: 5, sender: "me", time: "12:37", content: "Donec lobortis mattis...", type: "text" },
    { id: 6, sender: "ellie", time: "11:04", content: "Ok lets do it!", type: "text" },
  ];
    ...
    {/* pro user and pro constractor messaging */}
    {
      ...
      <div className="w-80 bg-white border-r border-gray-200 flex flex-col">
        ...
        <div className="flex gap-6 text-sm font-medium px-4 pt-3 mb-3">
          <button
            className={`pb-2 ${activeTab === "messages" ? "text-blue-600 border-b-2 border-blue-600" : "text-gray-500"}`}
            onClick={() => setActiveTab("messages")}
          >
            Messages
          </button>
          <button
            className={`pb-2 relative ${activeTab === "ask" ? "text-blue-600 border-b-2 border-blue-600" : "text-gray-500"}`}
          ...
          </div>
 {
  vipContractor && (
             <div>
            <button className="bg-blue-600 text-white px-5 py-1 rounded-xl">Call</button>
          </div>
  )
 }
        </div>
        ...
        <div className="flex-1 overflow-y-auto p-4 space-y-4">
          {messages.map((msg) => (
            <div key={msg.id} className={`flex items-start space-x-3 ${msg.sender === "me" ? "justify-end" : ""}`}>
              {msg.sender !== "me" && (
                <Image
                ...
                {msg.type === "text" ? (
                  <div
                    className={`px-4 py-2 rounded-2xl text-sm ${
                      msg.sender === "me" ? "bg-blue-500 text-white" : "bg-blue-100 text-gray-800"
                    }`}
                  >
                    {msg.content}
                  </div>
    ...
    <div className="flex container mx-auto my-12 bg-gray-50 rounded-xl overflow-hidden">
      ...
      <div className="w-80 bg-white border-r border-gray-200 flex flex-col">
        ...
        <div className="flex gap-6 text-sm font-medium px-4 pt-3">
          <button
            className={`pb-2 mb-3 ${activeTab === "messages" ? "text-blue-600 border-b-2 border-blue-600" : "text-gray-500"}`}
            onClick={() => setActiveTab("messages")}
          >
            Messages
          </button>
