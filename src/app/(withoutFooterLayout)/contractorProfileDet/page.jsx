      ...
      <div>
       ...
       <Link href={'/addProject'}>
               ...
               <button
                 ...
                 className="w-full h-full border-2 border-dashed border-gray-300 hover:border-blue-500 rounded-xl flex items-center justify-center bg-gray-50 hover:bg-blue-50 transition-all duration-200 hover:scale-105"
               >
                 <div className="text-center">
                   ...
                   <p className="text-gray-600 text-base font-medium">Add More Project</p>
