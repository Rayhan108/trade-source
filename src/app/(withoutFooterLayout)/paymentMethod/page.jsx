      ...
      <div className="bg-white p-4 max-w-7xl rounded-md mx-auto my-5">
        ...
        <div className="mt-8 pt-6 border-t border-gray-200">
          ...
          <div className="flex justify-center my-3 gap-3">
            ...
            <p className="text-xl">I understand that I am purchasing an automatically renewing membership. I accept all terms and conditions of Angi Key membership.</p>
          </div>
          <div className="text-center my-5">

          <button className="bg-[#1D69E1] w-[70%]  rounded-md font-bold  text-white px-4 py-2">Purchase Membership</button>
          </div>
        </div>
      </div>
    </div>
