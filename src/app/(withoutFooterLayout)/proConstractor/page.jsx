...
const ProConstractorPage = () => {
    return (
        <div className='max-w-7xl my-8 mx-auto'>
            ...
            <p className='text-lg my-3'>Choose the person you are looking for a guidance from!</p>

 <div className=" bg-white rounded-xl p-7 p-4 space-y-6">
          ...
          <div className="w-full lg:w-1/2 bg-green-200 p-6 flex flex-col justify-between">
            <div className="space-y-2">
              ...
              <div className="flex items-center gap-2 text-sm text-gray-800">
                ...
                <span className="font-bold">{contractor.completedTasks}</span> Completed Task
              </div>

              <div className="flex items-center gap-2 text-sm text-gray-800">
                <FaStar className="text-yellow-500" />
                <span className="font-bold">{contractor.rating}</span> ({contractor.reviews} reviews)
              </div>
            </div>

            <div className="flex justify-between items-center mt-4">
              <div className="text-gray-800 text-sm font-medium">Expertise</div>
              <div className="text-xl font-bold text-gray-900">{contractor.rate}</div>
            </div>
