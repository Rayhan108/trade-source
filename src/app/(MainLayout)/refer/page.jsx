          ...
          <div className="order-2 lg:order-1">
            ...
            <div className="mb-8">
              <p className="text-gray-700 text-lg mb-4 leading-relaxed">
                At YourTradeSource (YTS), we believe great work is worth sharing. Refer a friend, and you both earn
                rewards!
              </p>

              <p className="text-gray-700 text-lg mb-4 font-medium">Here's how it works:</p>
...
<Image src={refer} alt="" width={500} height={500} className="w-96"/>
          </div>
        </div>
      </div>
    </div>
