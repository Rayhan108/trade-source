...
const Statics = () => {
    return (
      ...
      <h2 className="text-2xl font-semibold text-gray-900 mb-6">Contractor Dashboard</h2>
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        ...
        <div className="bg-gray-100 rounded-md p-4 flex flex-col justify-between">
          ...
          <div className="mt-4">
            <p className="text-2xl font-bold text-gray-900">4.98 <span className="text-sm font-medium text-gray-700">rating</span></p>
