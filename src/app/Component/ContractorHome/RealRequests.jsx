  ...
  const jobRequests = [
    {
      ...
      description: "Need a licensed plumber to repair a slow leak in my bathroom tap. Preferably available this week.",
      clientName: "Rachel T.",
        ...
        <div className="max-w-7xl mx-auto">
          ...
          <div className="text-center mb-12">
            ...
            <p className="text-lg md:text-xl text-gray-600 max-w-4xl mx-auto leading-relaxed">
              When people know what they want, and you know how to help them - well, that's when real work begins. These
              are real voices, with real needs. All you have to do is listen.
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 lg:gap-8">
            {jobRequests.map((request) => (
              ...
              >
                {/* Time stamp */}
                <div className="text-sm text-gray-500 mb-4">{request.timeAgo}</div>
                ...
                <div className="space-y-3 mb-6">
                  <div className="font-semibold text-gray-800 text-lg">{request.clientName}</div>
