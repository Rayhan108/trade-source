...
const Footer = () => {
  return (
    <footer className={`bg-[#2C3E50] text-white py-10 px-5 ${styles.fontUrbanist}`}>
      <div className="container mx-auto flex flex-col md:flex-row md:justify-between md:items-start gap-10">
        ...
        <div className="flex flex-col md:w-1/3">
          <div className="w-[379px] max-w-full mb-4 relative" style={{height: 176}}>
            <Image src={logo} alt="YTS Logo" layout="fill" objectFit="contain" />
          </div>
          <div className="flex flex-col md:flex-row md:gap-20">
            <div>
              <h3 className="text-green-500 font-semibold text-2xl mb-2">Address</h3>
              <address className={`text-xl not-italic leading-snug ${styles.lineClamp3}`}>
            ...
            <div className="mt-8 md:mt-0 w-full">
              <h3 className="text-green-500 font-semibold text-2xl mb-2">Address</h3>
              <address className={`not-italic leading-snug text-xl ${styles.lineClamp3}`}>
        ...
        <div className="md:w-1/3 flex flex-col md:flex-row md:justify-between gap-6">
          ...
          <div className="mt-16">
            ...
            <ul className="text-xl space-y-5">
              ...
              <li>Articles</li>
              <li className="text-green-500 font-semibold">Become a VIP pro contractor</li>
            </ul>
