...
const RecentArticle = () => {
  ...
  },
  {
    ...
    "description": "Lorem Ipsum has roots in a piece of classical Latin literature from 45 BC, making it over 2000 years old."
  },
  {
    "id": 3,
    "image": article3,
...
<div>    <h1 className={`text-4xl  ${styles.fontDmSans}`}><span className='bg-[#1D69E1] text-white px-3'>Recent</span> Article</h1></div>
<div><p className='underline text-2xl'>See All Articles</p></div>
